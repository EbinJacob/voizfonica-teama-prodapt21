...
public class InvoiceController {
	...
	public Invoice rechargeAccount(@RequestParam("planId") int planId, @RequestParam("userId") int userId) throws Exception {
	...
	public List<Invoice> getUserInvoices(@PathVariable int UserId) throws Exception{
